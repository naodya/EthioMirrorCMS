...
<title>Content management ::: Ethiomirror ::: Users</title>
<style type="text/css">
<!--
...
function resetForm()
{
	...
	document.form1.hiduserid.value=0;
	...
	document.form1.chkuseractive.checked=false;
...
{
	$edituser=array($_REQUEST['userid'],$_REQUEST['fullname'],$_REQUEST['username'],$_REQUEST['gg'],$_REQUEST['isadmin'],$_REQUEST['active']);
}
if($_REQUEST['action']=="addnew")
{
	$user->id=$_POST['hiduserid'];
	$user->fullname=$_POST['txtfullname'];
	$user->username=$_POST['txtusername'];
	$user->password=$_POST['txtpassword'];
	$user->isadmin=$_POST['chkadmin'];
	$user->active=$_POST['chkuseractive'];
      ...
      <tr>
        <td height="135" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="134">&nbsp;</td>
            <td valign="top"><form id="form1" name="form1" method="post" action="users.php?action=addnew">
              <table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr bgcolor="#CB9F94">
                  <td colspan="6" bgcolor="#B7C7F8"><div align="center"><span class="style11">Add Users</span></div></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="left" valign="bottom" class="style7">&nbsp;</td>
                  <td width="86%" height="17" colspan="4" align="left" valign="bottom" class="style7"><input name="hiduserid" type="hidden" id="hiduserid" value="<?php echo $edituser[0]; ?>" /></td>
                </tr>
                <tr>
                  ...
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield1">
                    <input name="txtfullname" type="text" id="txtfullname" value="<?php echo $edituser[1]; ?>" size="40" />
                    <span class="textfieldRequiredMsg">Full name is required.</span>                     </span></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Username:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield2">
                    <input name="txtusername" type="text" id="txtusername" value="<?php echo $edituser[2]; ?>" size="40" />
                    <span class="textfieldRequiredMsg">A username is required.</span>                    </span></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Password:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield3">
                ...
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Administrator</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><input name="chkadmin" type="checkbox" id="chkadmin" value="1" <?php if (!(strcmp("$edituser[4]",1))) {echo "checked=\"checked\"";} ?> /></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Active</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><input name="chkuseractive" type="checkbox" id="chkuseractive" value="1" <?php if (!(strcmp("$edituser[5]",1))) {echo "checked=\"checked\"";} ?> /></td>
                </tr>
                <tr bgcolor="f2f2f2">
                  ...
                  <td height="19" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="11%"><span class="style7">
                          <input name="Button" type="button" class="style2" value="NEW USER" onclick="resetForm();"/ >
                        </span></td>
                        <td width="89%" align="left"><span class="style7">
                          <input name="Submit2" type="submit" class="style2" value="SAVE USER" />
                        </span></td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <br />
              ...
              <tr bgcolor="#CB9F94">
                <td bgcolor="#B7C7F8"><div align="center"><span class="style11">List of users</span></div></td>
              </tr>
              ...
              <tr>
                <td align="left" valign="bottom" class="style8"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableboarder">
                    ...
                    <tr>
                      <td width="23%" height="28" align="left"><span class="style40">Full name</span></td>
                      <td width="23%" align="left" class="style40">Username</td>
                      <td width="12%" align="center" class="style40">Administrator</td>
                      <td width="12%" align="center" class="style40">Active</td>
                      <td width="30%" align="center" class="style40"><span class="style33">Action</span></td>
                    </tr>
                    <?php $user->getUser();?>
                  </table>
                    <br />
