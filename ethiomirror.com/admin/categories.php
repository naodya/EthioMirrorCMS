      ...
      <tr>
        <td height="135" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="134">&nbsp;</td>
            <td valign="top"><form id="form1" name="form1" method="post" action="categories.php?action=addnew">
              <table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr bgcolor="#CB9F94">
                  <td colspan="6" bgcolor="#B7C7F8"><div align="center"><span class="style11">Add Category</span></div></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="left" valign="bottom" class="style7">&nbsp;</td>
                  <td width="86%" height="17" colspan="4" align="left" valign="bottom" class="style7"><input name="hidcatid" type="hidden" id="hidcatid" value="<?php echo $editcategory[0]; ?>" /></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Category name</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield1">
                    <input name="txtcategoryname" type="text" id="txtcategoryname" value="<?php echo $editcategory[1]; ?>" size="40" />
                ...
                <tr>
                  ...
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><input name="txtdescription" type="text" id="txtdescription" value="<?php echo $editcategory[2]; ?>" size="40" /></td>
                </tr>
                <tr bgcolor="f2f2f2">
                  ...
                  <td height="19" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="11%"><span class="style7">
                          <input name="Button" type="button" class="style2" value="NEW CATEGORY" onclick="resetForm();"/ >
                        </span></td>
                        <td width="89%"><span class="style7">
                          <input name="Submit2" type="submit" class="style2" value="SAVE CATEGORY" />
                        </span></td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <br />
              ...
              <tr bgcolor="#CB9F94">
                <td bgcolor="#B7C7F8"><div align="center"><span class="style11">List of  news Categories</span></div></td>
              </tr>
              ...
              <tr>
                <td align="left" valign="bottom" class="style8"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableboarder">
                    ...
                    <tr>
                      <td width="30%" height="28" align="left"><span class="style40">Category name</span></td>
