...
<title>Content management ::: Ethiomirror ::: Published news</title>
<style type="text/css">
<!--
...
{
  if (confirm("Are you sure you want to unpublish the news from the website?"))
  {
...
{
  if (confirm("Are you sure you want to COMPLETELY REMOVE the news with its RELATED FILES?"))
  {
    document.location = delUrl;
  }
}
        ...
        <td height="135" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr bgcolor="#CB9F94">
                <td align="left" bgcolor="#F2F2F2"><a href="newsdesk.php?currentdate=<?php echo date('Y-m-d');?>" class="style38">ADD NEWS</a></td>
              </tr>
              <tr bgcolor="#CB9F94">
                <td bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
              <tr bgcolor="#CB9F94">
                <td bgcolor="#B7C7F8"><div align="center"><span class="style11">News view</span></div></td>
              </tr>
              <tr>
                <td align="left" valign="bottom" class="style8"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableboarder">
                    ...
                    <tr>
                      <td width="10%" height="28" align="left"><span class="style40">Date Posted</span></td>
                      <td width="30%" align="left"><span class="style40">Headline</span></td>
                      <td width="15%" align="left" class="style40"><span class="style33">Category</span></td>
                      <td width="14%" align="left" class="style40"><span class="style33">Section</span></td>
                      <td width="12%" align="left" class="style40"><span class="style33">Reported by</span></td>
              ...
              <tr bgcolor="f2f2f2">
                <td height="19" align="left" bgcolor="f2f2f2"><a href="newsdesk.php?currentdate=<?php echo date('Y-m-d');?>" class="style38">ADD NEWS</a></td>
                </tr>
            </table></td>
          </tr>
          <tr>
