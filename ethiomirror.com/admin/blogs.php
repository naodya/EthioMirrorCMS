...
<title>Content management ::: Ethiomirror ::: Blogs</title>
<style type="text/css">
<!--
...
function resetForm()
{
	...
	document.form1.hidblogid.value=0;
	document.form1.txtblogname.value="";
...
{
	$editblog=array($_REQUEST['blogid'],$_REQUEST['blog'],$_REQUEST['url']);
}
if($_REQUEST['action']=="addnew")
{
	$blog->id=$_POST['hidblogid'];
	$blog->blog=$_POST['txtblogname'];
	$blog->url=$_POST['txturl'];
      ...
      <tr>
        <td height="135" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="134">&nbsp;</td>
            <td valign="top"><form id="form1" name="form1" method="post" action="blogs.php?action=addnew">
              <table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr bgcolor="#CB9F94">
                  <td colspan="6" bgcolor="#B7C7F8"><div align="center"><span class="style11">Add Blogs</span></div></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="left" valign="bottom" class="style7">&nbsp;</td>
                  <td width="86%" height="17" colspan="4" align="left" valign="bottom" class="style7"><input name="hidblogid" type="hidden" id="hidblogid" value="<?php echo $editblog[0]; ?>" /></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Blog name</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield1">
                    <input name="txtblogname" type="text" id="txtblogname" value="<?php echo $editblog[1]; ?>" size="40" />
                ...
                <tr>
                  ...
                  <input name="txturl" type="text" id="txturl" value="<?php echo $editblog[2]; ?>" size="40" />
                  ...
                  <td height="19" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="11%"><span class="style7">
                          <input name="Button" type="button" class="style2" value="NEW BLOG" onclick="resetForm();"/ >
                        </span></td>
                        <td width="89%"><span class="style7">
                          <input name="Submit2" type="submit" class="style2" value="SAVE BLOG" />
                        </span></td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <br />
              ...
              <tr bgcolor="#CB9F94">
                <td bgcolor="#B7C7F8"><div align="center"><span class="style11">List of Blogs </span></div></td>
              </tr>
              ...
              <tr>
                <td align="left" valign="bottom" class="style8"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableboarder">
                    ...
                    <tr>
                      <td width="30%" height="28" align="left"><span class="style40">Blog name</span></td>
