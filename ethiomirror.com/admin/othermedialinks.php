...
<title>Content management ::: Ethiomirror ::: Other media links</title>
<style type="text/css">
<!--
...
{
  if (confirm("Are you sure you want remove this blog?"))
  {
    document.location = delUrl;
  }
}
...
function resetForm()
{
	...
	document.form1.hidlinkid.value=0;
	document.form1.txtlinkname.value="";
	document.form1.txturl.value="http://www.";
}
</script>
...
{
	$editlink=array($_REQUEST['linkid'],$_REQUEST['link'],$_REQUEST['url']);
}
if($_REQUEST['action']=="addnew")
{
	$link->id=$_POST['hidlinkid'];
	$link->link=$_POST['txtlinkname'];
	$link->url=$_POST['txturl'];
	
	$link->saveLink();		
	echo "<script>window.location.href='othermedialinks.php'</script>";
}
      ...
      <tr>
        <td height="135" colspan="2" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="134">&nbsp;</td>
            <td valign="top"><form id="form1" name="form1" method="post" action="othermedialinks.php?action=addnew">
              <table width="100%"  border="0" cellpadding="0" cellspacing="2">
                <tr bgcolor="#CB9F94">
                  <td colspan="6" bgcolor="#B7C7F8"><div align="center"><span class="style11">Add Media Link</span></div></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="left" valign="bottom" class="style7">&nbsp;</td>
                  <td width="84%" height="17" colspan="4" align="left" valign="bottom" class="style7"><input name="hidlinkid" type="hidden" id="hidlinkid" value="<?php echo $editlink[0]; ?>" /></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">Other media link name</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield1">
                    <input name="txtlinkname" type="text" id="txtlinkname" value="<?php echo $editlink[1]; ?>" size="40" />
                    <span class="textfieldRequiredMsg">Required value</span> </span></td>
                </tr>
                <tr>
                  <td height="17" colspan="2" align="right" valign="middle" class="style7"><span class="style24">URL</span><span class="style24">:</span></td>
                  <td height="17" colspan="4" align="left" valign="middle" class="style7"><span id="sprytextfield2">
                  <input name="txturl" type="text" id="txturl" value="<?php echo $editlink[2]; ?>" size="40" />
                  <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid URL format eg:http://www.ethiomirror.com</span></span></td>
                </tr>
                <tr bgcolor="f2f2f2">
                  ...
                  <td height="19" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="14%"><span class="style7">
                          <input name="Button" type="button" class="style2" value="NEW MEDIA LINK" onclick="resetForm();"/ >
                        </span></td>
                        <td width="86%"><span class="style7">
                          <input name="Submit2" type="submit" class="style2" value="SAVE MEDIA LINK" />
                        </span></td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <br />
              ...
              <tr bgcolor="#CB9F94">
                <td bgcolor="#B7C7F8"><div align="center"><span class="style11">List of Other Media Links</span></div></td>
              </tr>
              ...
              <tr>
                <td align="left" valign="bottom" class="style8"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableboarder">
                    ...
                    <tr>
                      <td width="30%" height="28" align="left"><span class="style40">Other media link name</span></td>
                      <td width="15%" align="left" class="style40"><span class="style33">URL</span></td>
                      <td width="19%" align="center" class="style40"><span class="style33">Action</span></td>
                    </tr>
                    <?php $link->getOtherlink1();?>
                  </table>
                    <br />
                    <br /></td>
              </tr>
