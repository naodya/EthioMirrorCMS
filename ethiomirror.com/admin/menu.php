...
<TR>
                        ...
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
<TD align="left" class='style14'>&nbsp; <a href='../titleone.htm'></a><a href='../titleone.htm'></a><a href='controlpannel.php'>Control panel</a></TD>
  </TR>                        
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
...
<TD align="left" class='style14'>&nbsp; <a href='archive.php'>Archived news</a></TD>
  ...
  <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
    <TD align="left" class='style14'>&nbsp; <a href='categories.php'>Categories</a></TD>
  </TR>
  <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
<TD align="left" class='style14'>&nbsp; <a href='subcategories.php'>Subcategories</a></TD>
                        </TR>                        
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
                          <TD align="left" class='style14'>&nbsp; <a href='sections.php'>Sections</a></TD>
  </TR>
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
                        ...
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
                          <TD align="left" class='style14'>&nbsp; <a href='../semesterreg.php'></a><a href='reporters.php'>Reporters</a></TD>
                        </TR>
                        <TR onmouseover=this.style.backgroundColor='#CCFFCC'; onmouseout=this.style.backgroundColor='#ffffff';>
<TD align="left" class='style14'>&nbsp; <a href='../semesterreg.php'></a><a href='users.php'>Users</a></TD>
  </TR>                        
